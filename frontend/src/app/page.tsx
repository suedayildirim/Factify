...
import { useAnalyze } from '@/features/analyze/useAnalyze';
import type { Finding } from '@/features/analyze/types';
...
export default function HomePage() {
  const { text, setText, loading, error, result, history, canAnalyze, analyze, clearHistory } =
    useAnalyze();
